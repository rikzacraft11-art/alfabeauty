...
3) **Conversion**: jalur cepat ke WhatsApp (`+628151168745`) untuk konsultasi + **Become Partner** (lead capture) dengan profil dasar.
4) **Contact**: email `alfabeautycosmeticaa@gmail.com`, social media **Instagram only** (handle TBD).
...
|---|---|---|
| WhatsApp target number | `+628151168745` | Format E.164: `+62 815-1168-8745` |
| WhatsApp prefill message | _TBD_ | Disepakati dengan Owner (tone B2B) |
| Fallback contact email | `alfabeautycosmeticaa@gmail.com` | Dipakai saat device tidak support deep link |
| Social media | Instagram only (handle TBD) | Tidak ada YouTube, TikTok, dll. |
...
- Primary domain: `alfabeauty.co.id`
...
**Pre-launch:** DNS/SSL (primary `alfabeauty.co.id`), WA number (`+628151168745`) + prefill message, robots/sitemap, analytics, OG/Twitter, JSON-LD, security headers snapshot.  
