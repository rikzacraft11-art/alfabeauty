...
- CTA WhatsApp ke **nomor WhatsApp Indonesia** (`+628151168745`) + **pesan prefill**.
- Email kontak publik: `alfabeautycosmeticaa@gmail.com`
- Social media: **Instagram only** (handle TBD).
...
- Pengadaan domain/email perusahaan (domain `alfabeauty.co.id` sudah tersedia).
...
1) Nomor WhatsApp: **+628151168745** (`+62 815-1168-8745`)
2) Email kontak publik: **<alfabeautycosmeticaa@gmail.com>**
3) Social media: **Instagram only** (handle TBD)
4) Pesan prefill

### G) Domain & koordinasi go-live

1) Domain publik: `alfabeauty.co.id`
2) PIC IT yang memegang akses DNS/SSL saat go-live
3) PIC IT yang memegang akses DNS untuk setup record email (**SPF/DKIM/DMARC**) pada domain pengirim notifikasi
