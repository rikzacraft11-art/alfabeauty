...
```mermaid
graph TD
  A["SEO + AEO + GEO Strategy"] --> B["CITE Framework"]
  B --> C["C - CORE: Can machine find you?"]
  B --> D["I - INTENT: Aligned with needs & context of audience?"]
  B --> E["T - TAKE A POSITION: What is your authoritative take?"]
  B --> F["E - ENTITY: Is the world talking about you as a distinct entity?"]
```
