...
export function SiteHeader(): React.JSX.Element {
    ...
    return (
        ...
        >
            <div className="mx-auto flex h-[var(--header-height)] max-w-[1440px] items-center justify-between px-6 sm:px-8 lg:px-12">
                ...
                <div className="flex items-center gap-5 xl:gap-8 h-full">
                    ...
                    <NavigationMenu
                        className="hidden lg:flex h-[var(--header-height)] items-stretch"
                        viewport={true}
                        fullWidth={true}
                ...
                {/* ─── Right Group: Credit Application, ID/EN, Partner Login, Mobile Drawer ─── */}
                <div className="flex items-center gap-3.5 xl:gap-5 shrink-0">
                    ...
                    {/* Partner Login CTA (Yucca style pill button) */}
                    <Link
                        href="/partnership"
                        className={cn(
                            "hidden sm:inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-[11.5px] xl:text-[12px] font-medium tracking-[0.02em] whitespace-nowrap transition-all duration-[350ms] ease-[var(--ease)] group shadow-xs",
                            isSolid
                                ? "bg-foreground text-white hover:bg-foreground/90 hover:shadow-sm"
                                : "bg-white text-charcoal hover:bg-white/90 hover:shadow-sm"
                        )}
                    >
