...
import { X, ChevronRight, FileText, ArrowRight, MessageCircle } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { cn } from "@/shared/lib/utils";
import { BRANDS, WHATSAPP_URL, PRODUCT_CATEGORIES, PILLARS, NAV_LINKS } from "@/shared/lib/config";
import { mobileMenuStagger, mobileMenuItemFade, smoothEase } from "@/shared/lib/motion";
...
export function MobileMenu({ onClose }: MobileMenuProps) {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="flex h-[var(--header-height)] items-center justify-between border-b border-border-warm/40 px-6">
