...
export const idDictionary: Dictionary = {
  ...
  hero: {
    ...
    titleLine1: "Distributor Resmi & Akademi",
    titleLine2: "Perawatan Rambut Profesional",
    titleLine3: "Salon & Barber Indonesia",
    description:
      "PT Alfa Beauty Cosmetica adalah importir dan distributor tunggal resmi brand perawatan rambut profesional terkemuka asal Italia dan Spanyol. Menyediakan pasokan original 100% berizin BPOM untuk Alfaparf Milano, Montibello, Farmavita, dan Gamma+ Più, didukung program pelatihan teknis di Alfa Beauty Academy.",
    exploreBrands: "JELAJAHI PRODUK RESMI",
    partnerWithUs: "PENGAJUAN KEMITRAAN SALON",
    scrollPrompt: "GULIR UNTUK MENJELAJAH",
    dockedBadge: "DISTRIBUTOR RESMI NASIONAL",
    dockedHeading: "Suplai Resmi Produk Salon & Pelatihan Teknis",
    dockedDescription: "Lebih dari 18 tahun menjadi mitra terpercaya salon dan barbershop di seluruh Indonesia.",
  },
  shopCTA: {
    eyebrow: "KATALOG PRODUK RESMI",
    heading:
      "Pasokan produk perawatan rambut profesional impor resmi langsung dari pabrik Italia dan Spanyol untuk salon dan barbershop Anda.",
    ...
    brands: [
      {
        ...
        headline: "Pewarnaan, perawatan, dan pelurusan rambut profesional dari Milano, Italia.",
        subheading: "Jelajahi Alfaparf Milano",
        description: "Brand nomor 1 di industri salon Italia, terkenal melalui lini pewarnaan Evolution of the Color, perawatan Semi di Lino, dan pelurusan Lisse Design Keratin Therapy.",
      ...
      },
      {
        ...
        slug: "montibello",
        name: "Montibello",
        headline: "Inovasi pewarnaan dan perawatan rambut berkelanjutan dari Barcelona, Spanyol.",
        subheading: "Jelajahi Montibello",
        description: "Warisan lebih dari 50 tahun inovasi salon dari Barcelona. Pelopor pewarnaan berkondisioner Cromatone dan lini perawatan ramah lingkungan Hop.",
      ...
      },
      {
        ...
        headline: "Peralatan cukur dan pengering rambut profesional presisi tinggi dari Brescia, Italia.",
        subheading: "Jelajahi Gamma+ Professional",
        description: "Standar alat pilihan barber dan stylist dunia, memadukan motor bertenaga tinggi, bilah presisi, dan daya tahan untuk pemakaian salon intensif.",
      ...
      },
      {
        ...
        slug: "farmavita",
        name: "Farmavita",
        headline: "Formulasi pewarnaan dan perawatan rambut salon andal dari Milano, Italia.",
        subheading: "Jelajahi Farmavita",
        description: "Solusi lengkap produk salon profesional dengan keunggulan lini Life Color Plus, B.life Color bebas amonia, dan perawatan Argan Sublime.",
        editorialImage: "/images/home/editorial-alfaparf.jpg",
      ...
      },
      {
        ...
        headline: "Sistem pelurusan kimia dan perm profesional formulasi Jepang.",
        subheading: "Jelajahi Core Professional",
        description: "Formulasi kimia perm modern, digital perm, dan pengontrol alkali khusus untuk tekstur rambut Asia.",
        editorialImage: "/images/home/editorial-gammaplus.jpg",
