    ...
    return (
        <div className="mx-auto max-w-3xl px-6 pt-[calc(var(--header-height)+2rem)] pb-24 sm:px-8 lg:px-12">
            ...
            <div className="space-y-8 text-body leading-relaxed text-foreground/80">
                <section>
                    <h2 className="mb-3 text-h4 font-bold">1. Information We Collect</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">2. How We Use Your Information</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">3. Data Storage &amp; Security</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">4. Third-Party Services</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">5. Cookies &amp; Analytics</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">6. Your Rights</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">7. Changes to This Policy</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-3 text-h4 font-bold">8. Contact</h2>
                    <p>
