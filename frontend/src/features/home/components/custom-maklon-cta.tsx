...
export function CustomMaklonCTA(): React.JSX.Element {
    return (
        <section className="section section-cta section-cta-main bg-[#12231A] text-white py-16 sm:py-24 lg:py-28 overflow-hidden">
            <div className="mx-auto max-w-[1400px] px-6 sm:px-8 lg:px-12">
                ...
                <div className="mt-12 sm:mt-16 pt-8 border-t border-white/15">
                    ...
                    >
                        ...
                        <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/20 transition-all duration-300 group-hover:scale-110 group-hover:border-white group-hover:bg-white group-hover:text-[#12231A]">
